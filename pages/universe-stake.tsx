import {
  ...
  const Stake: NextPage = () => {
    ...
    const { contract, isLoading } = useContract(universeStakingContractAddress);
    ...
    async function stakeNft(id: string) {
      ...
      if (!isApproved) {
        await nftDropContract?.setApprovalForAll(universeStakingContractAddress, true);
      }
        ...
        {!address ? (
          ...
          <>
            ...
            <Web3Button
              ...
              contractAddress={universeStakingContractAddress}
            >
              Claim Rewards
            </Web3Button>
